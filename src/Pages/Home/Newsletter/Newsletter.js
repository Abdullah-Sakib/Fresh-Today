...
const Newsletter = () => {
    ...
    const sendEmail = (e) => {
        ...
        emailjs.sendForm('service_2wbnn8k', 'template_e88ae1k', form.current, 'O0mKdcMXfdXA1G-W7')
        .then((result) => {
    ...
    return (
        <div className='bg-lime-300 py-20 my-36 grid justify-center'>
            ...
            <form ref={form} onSubmit={sendEmail}  className='pl-8'> 
                <input type="email" onChange={handleInput} name="userEmail" placeholder="Put your email here" className="input w-full max-w-xs mr-2 rounded-none" required />
