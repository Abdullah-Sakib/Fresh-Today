...
const Highlight = () => {
    return (
        <div>
            <div className="my-64 shadow-lg font-family 2xl:container 2xl:mx-auto md:py-12 py-9 bg-gray-50">
            <div className=" bg-gray-50 grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 lg:gap-8 md:gap-12 gap-14 lg:px-20 lg:py-12 py-10 md:px-12 px-4">
                ...
                <div>
                    ...
                    <p className=" text-base leading-6 font-normal text-gray-600 mt-4 lg:w-full md:w-9/12 w-full">Free delivery over orders above 1000 /-</p>
                </div>
                ...
                <div>
                    ...
                    <p className=" text-base leading-6 font-normal text-gray-600 mt-4 lg:w-full md:w-9/12 w-full">
                        Our customer care is available 24/7 at <span className=" font-semibold cursor-pointer">+8801711-735378</span> and <span className=" font-semibold cursor-pointer">customercare@gmail.com</span>
                    </p>
                </div>
