...
const Products = () => {
  ...
  <div class="w-full max-w-sm bg-white rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700 mt-9">
    {/* <a href="#"> */}
        <img class="p-8 rounded-t-lg" src={p.image} className='h-80 w-full ' alt="product image" />
    {/* </a> */}
    <div class="px-5 pb-5">
        ...
        <div class="flex items-center justify-between">
            ...
            <a href="#" class="text-white bg-lime-700 hover:bg-lime-900 focus:ring-4 focus:outline-none focus:ring-lime-300 font-medium rounded-lg text-sm px-3 mx-3 py-2.5 text-center dark:bg-lime-600 dark:hover:bg-lime-700 dark:focus:ring-lime-800">Buy Now</a>
        </div>
    </div>
</div>
