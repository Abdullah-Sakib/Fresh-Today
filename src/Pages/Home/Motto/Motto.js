...
const Motto = () => {
  return (
    <div className="flex items-center justify-between w-full  mt-16 md:mt-28 lg:mt-32 ">
      <div className="flex flex-col lg:flex-row w-full lg:justify-between items-start lg:items-center rounded bg-gradient-to-r from-lime-200 via-green-100 to-lime-300  shadow p-9">
