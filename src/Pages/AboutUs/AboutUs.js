          ...
          <div className="grid grid-cols-1 gap-8 mt-8 xl:mt-16 md:grid-cols-2 xl:grid-cols-2">
            <div className="px-12 py-8 transition-colors shadow-lg duration-300 transform border rounded-xl hover:border-transparent group hover:bg-lime-200 dark:border-gray-700 dark:hover:border-transparent ">
              <div className="flex flex-col sm:-mx-4 sm:flex-row">
                <img
                  ...
                  src="https://avatars.githubusercontent.com/u/86623039?v=4"
                  alt=""
                />
              ...
              <p className="mt-4 text-gray-500 capitalize dark:text-gray-300 group-hover:text-dark">
                A Enthusiastic individual who worked as a Web Developer with
                around 1 years of experience. Extensively worked developing
                Responsive Web Applications. Experience in developing web page
                effectively using HTML5,REACTJS,TAILWIND CSS,CSS3 and so
                trending languages in making web pages cross-browser compatible.
              </p>
            ...
            <div className="px-12 py-8 transition-colors shadow-lg duration-300 transform border rounded-xl hover:border-transparent group hover:bg-lime-200 dark:border-gray-700 dark:hover:border-transparent">
              <div className="flex flex-col sm:-mx-4 sm:flex-row">
                <img
                  className="flex-shrink-0 object-cover w-24 h-24 rounded-full sm:mx-4 ring-4 ring-gray-300"
                  src="https://avatars.githubusercontent.com/u/108396938?s=400&u=7692a82c285b28c9703176ff5a65f6fd258b4f7c&v=4"
                  alt=""
                />
